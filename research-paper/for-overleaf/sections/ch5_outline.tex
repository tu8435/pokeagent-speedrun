...
\begin{enumerate}
    ...
    \end{itemize}
    \item \textit{Bootstrapped Transfer Learning: equip H_min orchestrator with auto-evolved harness from previous execution + supervisor. This is tested in two settings (continued evolution where we allow the model to continue auto evolve from this initialization, or we freeze the harness at this point.}
\end{enumerate}
...
\subsubsection{Two Settings}\label{sec:three_settings_results}
