#!/usr/bin/env python3
"""Tests for utils/metric_tracking/claude_session_reader.py (Issues 9, 10, 11)."""
...
from utils.metric_tracking.claude_session_reader import (
    _create_unique_hash,
    _parse_timestamp,
...
class TestAppendCliStepIntegration:
    ...
    def test_steps_appended_to_cumulative_metrics(self, tmp_path):
        ...
        with patch("utils.data_persistence.run_data_manager.get_cache_path", return_value=metrics_file):
            ...
            from utils.metric_tracking.claude_session_reader import load_new_usage_entries
